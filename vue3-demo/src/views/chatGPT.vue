<template>
  <div class="chat-gpt">
    ...
    <div>
      ...
      <highlightjs language="javascript" autodetect :code="textVal" v-else></highlightjs>
    </div>
    <el-input v-model="chatVal" :suffix-icon="Promotion" size="large" @keyup.enter="enterHandler" />
  </div>
</template>
